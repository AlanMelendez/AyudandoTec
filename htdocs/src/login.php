...
<head>
  ...
  <title>Bienvenido a AyudandoTec</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>AYUDANDO</b>TEC</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Bienvenido a AyudandoTec</p>
...

    {
      ...
      $query = mysqli_query("SELECT * FROM usuarios WHERE usuario = '$usuario' AND contrasena = '$contrasena'");
    ...
    <a href="registro.php" class="text-center">Registrarme en AyudandoTec</a>
